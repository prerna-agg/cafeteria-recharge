...
<div class="art-nav-inner">
	...
	<ul class="art-hmenu">
		...
		<li>
			<a href="insert_item.jsp" class="active">Insert Item</a>
		</li>
                <li>
                        <a href="remove_item.jsp">Remove Item</a>
                </li>
                <li>
                        <a href="view_comments.jsp">View Comments</a>
                </li>
                <li>
        ...
        while(rs.next())
        {
            %>
                ...
                <tr>
                    ...
                    <td width="10"><%= rs.getString("item_name") %></td>
                
                
                    <td width="10"><%= rs.getString("item_price") %></td>
                
                    <td width="20"><%= rs.getString("item_desp") %></td>
                    ...
                    <td width="10"><a href="delete_item.jsp?id="<%=rs.getString("item_id")%>>delete item</td>
                </tr>
            <%
        }
        %>
